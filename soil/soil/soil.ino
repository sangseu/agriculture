...
#define mqtt_topic_pub_soi "root/agriculture/soil/esp/soi"
#define mqtt_topic_sub "root/agriculture/soil/esp/control"
#define mqtt_topic_pub "root/agriculture/soil/esp/count"
...
#define pfodWifiWebConfigAP "esp_soi"
...
float f_soi;
int i_soi;//Using to convert float to in to send
char buf1[3];
char buf2[3];
...
void loop() {
  ...
  if (now - lastMsg > 10000)
  {
    ...
    sprintf(buf1, "%d", i_soi);
    String s_soi = "s"+(String)i_soi+"@";
    char buf2[5];
    s_soi.toCharArray(buf2, sizeof(buf2));
    Serial.print(buf2);
    Serial.print("-");
    

    clientPS.publish(mqtt_topic_pub_soi, buf2);
    Serial.println("pub");
  }//end if
}//===============================================================================end LOOP
