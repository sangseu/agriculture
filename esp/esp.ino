...
long lastMsg = 0; //the last get millis();
int value = 0;    //value on smartconfig
byte inConfigMode = 0; // false, in config mode
uint32_t timeout = 0;
const char *aps;//Scan strongest WiFi
//===========================
